#ifndef _SRC_MATH_CAMERA_H_
#define _SRC_MATH_CAMERA_H_
...
class Camera {
  public:
    ...
    bool Unproject(const Ellipse& ellipse, const Scalar radius, DualCircle* dual_circle) const;
    bool Unproject(const Vector2& point2d, const Scalar distance, Vector3* point3d) const;
  private:
